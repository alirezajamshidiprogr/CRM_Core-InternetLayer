    ...
    public class GridViewTagHelper : TagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (gridContext.Pagination != null)
            {
                ...
                html += string.Format(@"<div class='col-sm-6'><div class='col-sm-3' style='text-align:left;float:right;'>");
                html += string.Format("<button style='{0}' class='btn' onclick='ChangingGridPage(\"" + "backward" + "\", \"" + ActionName + "\" ,\"" + PageNumber +"\", \""+ TotalRowsCount + "\")' ><i aria-hidden='true' class='bx bx-chevron-right' style='margin-right: -9px;font-size:1.2em;'></i></button>", styleFirstRecord);
                html += string.Format("<button style='{0}' class='btn' onclick='ChangingGridPage(\"" + "right" + "\", \"" + ActionName + "\" ,\"" + PageNumber + "\", \"" + TotalRowsCount + "\")'><i aria-hidden='true' class='bx bx-last-page' style='margin-right: -9px;font-size:1.2em;'></i> </button> </div>", stylePreviousSecond);
                html += string.Format("<div class='col-sm-3' style='float:left;'><button class='btn' style='{0}' onclick='ChangingGridPage(\"" + "left" + "\", \"" + ActionName + "\" ,\"" + PageNumber + "\", \"" + TotalRowsCount + "\")'><i class='bx bx-first-page' aria-hidden='true' style='margin-right: -9px;font-size:1.2em;'></i> </button> ", styleLastRecord);
                html += string.Format("<button class='btn' onclick='ChangingGridPage(\"" + "forward" + "\", \"" + ActionName + "\" ,\"" + PageNumber + "\", \"" + TotalRowsCount + "\")' style='{0}'><i aria-hidden='true' class='bx bx-chevron-left' style='margin-right: -9px;font-size:1.2em;'></i> </button></div>", styleNextSecond);
