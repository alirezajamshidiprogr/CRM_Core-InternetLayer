...
namespace CRM_Core.DataAccessLayer.Migrations
{
    ...
    [Migration("20211002180446_AddCostsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.Salon.SalonCosts", b =>
                {
                    ...
                    b.Property<int?>("TransferCostsId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("BillCostsId")
                        .IsUnique()
                        .HasFilter("[BillCostsId] IS NOT NULL");

                    b.HasIndex("TransferCostsId")
                        .IsUnique()
                        .HasFilter("[TransferCostsId] IS NOT NULL");
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.Salon.SalonCosts", b =>
                {
                    b.HasOne("CRM_Core.Entities.Models.Salon.BillCosts", "BillCosts")
                        .WithOne("SalonCosts")
                        .HasForeignKey("CRM_Core.Entities.Models.Salon.SalonCosts", "BillCostsId");

                    b.HasOne("CRM_Core.Entities.Models.Salon.TransferCosts", "TransferCosts")
                        .WithOne("SalonCosts")
                        .HasForeignKey("CRM_Core.Entities.Models.Salon.SalonCosts", "TransferCostsId");

                    b.Navigation("BillCosts");

                    b.Navigation("TransferCosts");
                });
