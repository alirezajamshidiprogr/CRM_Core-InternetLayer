...
namespace CRM_Core.DataAccessLayer.Migrations
{
    ...
    [Migration("20210807174323_AddUserMenuTable")]
    partial class AddUserMenuTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.General.UserMenu", b =>
                {
                    b.HasOne("CRM_Core.Entities.Models.General.TBASMenu", "TBASMenu")
                        .WithMany()
                        .HasForeignKey("TBASMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TBASMenu");
                });
