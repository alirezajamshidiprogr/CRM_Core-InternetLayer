...
namespace CRM_Core.DataAccessLayer.Migrations
{
    ...
    [Migration("20220202172607_AddTablesPersonnel")]
    partial class AddTablesPersonnel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.AgreementType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.PersonnelSkils", b =>
                {
                    ...
                    b.Property<int?>("TBASPersonenelSkilsId")
                        .IsRequired()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TBASPersonenelSkilsId");
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.TBASPersonenelSkils", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.Personnel", b =>
                {
                    b.HasOne("CRM_Core.Entities.Models.AgreementType", "AgreementType")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.PersonnelSkils", b =>
                {
                    ...
                    b.HasOne("CRM_Core.Entities.Models.TBASPersonenelSkils", "TBASPersonenelSkils")
                        .WithMany()
                        .HasForeignKey("TBASPersonenelSkilsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Personnel");

                    b.Navigation("TBASPersonenelSkils");
                });
