...
namespace CRM_Core.DataAccessLayer.Migrations
{
    ...
    [Migration("20220319112355_EditRelatios")]
    partial class EditRelatios
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Core.DomainLayer.People", b =>
                {
                    ...
                    b.Property<int?>("PeopleVirtualId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM_Core.DomainLayer.People", b =>
                {
                    b.HasOne("CRM_Core.DomainLayer.Address", "Address")
                        .WithMany("People")
                    ...
                    b.HasOne("CRM_Core.DomainLayer.PeopleVirtual", null)
                        .WithMany("People")
                        .HasForeignKey("PeopleVirtualId");
            ...
            modelBuilder.Entity("CRM_Core.Entities.Models.Personnel", b =>
                {
                    b.HasOne("CRM_Core.DomainLayer.Address", null)
                        .WithMany("Personnel")
                        .HasForeignKey("AddressId");
